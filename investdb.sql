...
INSERT INTO `ExchangeRates` VALUES (1,'NGN','{\"EUR\":0.000786,\"GBP\":0.000671,\"USD\":0.000837,\"CAD\":0.001152,\"XAF\":0.515586,\"CLP\":0.800882,\"COP\":3.204593,\"EGP\":0.039815,\"GHS\":0.011255,\"GNF\":7.193256,\"KES\":0.108886,\"MWK\":1.450533,\"MAD\":0.008414,\"NGN\":1,\"RWF\":1.078045,\"SLL\":19.129164,\"STD\":17.32962,\"ZAR\":0.015723,\"TZS\":2.160134,\"UGX\":3.180847,\"XOF\":0.515576,\"ZMW\":0.0209}','2024-04-12 12:37:56','2024-04-12 12:37:56');
...
INSERT INTO `Investments` VALUES (1,'Cassava',50000,'Ibadan & Lagos, Nigeria',8,2500,15,NULL,'avaliable',1,'2022-08-18 05:25:06','2022-08-18 05:26:30',1,NULL),(2,'Cassava',50000,'Ibadan & Lagos, Nigeria',12,2500,13,NULL,'avaliable',1,'2022-08-18 05:33:36','2022-08-18 05:41:05',1,NULL),(3,'Cassava',50000,'Ibadan & Lagos, Nigeria',12,2500,15,'portfolio_photos/534597064.jpg','avaliable',0,'2022-08-23 11:07:11','2024-04-12 12:49:08',1,NULL),(4,'Fish',100000,'Lagos, Nigeria',6,1000,14,'portfolio_photos/685812789.jpg','avaliable',0,'2022-08-23 14:41:35','2024-04-12 12:48:25',3,NULL),(5,'Maize',50000,'Ibadan & Lagos, Nigeria',4,2000,20,'portfolio_photos/118223754.jpg','avaliable',0,'2022-08-23 14:45:02','2024-04-12 12:49:56',2,NULL);
...
CREATE TABLE `Payments` (
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `userInvestmentId` int DEFAULT NULL,
  `inf_reference` varchar(255) NOT NULL,
  `amount_settled` int DEFAULT NULL,
  `currency` varchar(255) DEFAULT NULL,
  `channel` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `payments_inf_reference` (`inf_reference`),
  KEY `userId` (`userId`),
  KEY `investmentId` (`investmentId`),
  KEY `Payments_userInvestmentId_foreign_idx` (`userInvestmentId`),
  KEY `payments_investment_id` (`investmentId`),
  CONSTRAINT `Payments_ibfk_15` FOREIGN KEY (`userId`) REFERENCES `Users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `Payments_ibfk_16` FOREIGN KEY (`investmentId`) REFERENCES `Investments` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `Payments_userInvestmentId_foreign_idx` FOREIGN KEY (`userInvestmentId`) REFERENCES `UserInvestments` (`id`)
...
INSERT INTO `Payments` VALUES (1,20,3,'Flutterwave',50000,'5020582','successful','2024-04-12 13:07:26','2024-04-12 13:07:26',7,'TNX_7',49300,'NGN','account'),(2,20,3,'Flutterwave',50000,'5020609','successful','2024-04-12 13:22:15','2024-04-12 13:22:15',10,'TNX_10',49300,'NGN','account');
...
CREATE TABLE `Transactions` (
  ...
  KEY `UserId` (`UserId`),
  CONSTRAINT `Transactions_ibfk_15` FOREIGN KEY (`user_id`) REFERENCES `Users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `Transactions_ibfk_16` FOREIGN KEY (`investment_id`) REFERENCES `Investments` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `Transactions_ibfk_17` FOREIGN KEY (`UserId`) REFERENCES `Users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `UserInvestments` VALUES (1,11,5,1,'pending',0,'2022-09-06 19:17:20','2022-09-06 19:17:20',NULL,NULL),(2,12,5,5,'pending',0,'2022-09-06 21:01:23','2022-09-06 21:01:23',NULL,NULL),(3,13,5,1,'pending',0,'2022-09-06 21:57:58','2022-09-06 21:57:58',NULL,NULL),(4,13,3,1,'pending',0,'2022-09-07 18:44:27','2022-09-07 18:44:27',NULL,NULL),(5,14,5,1,'pending',0,'2022-09-07 19:30:28','2022-09-07 19:30:28',NULL,NULL),(6,13,4,1,'pending',0,'2022-09-11 19:37:19','2022-09-11 19:37:19',NULL,NULL),(7,20,3,1,'active',0,'2024-04-12 13:05:03','2024-04-12 13:07:27','NGN',1.000000),(10,20,3,1,'active',0,'2024-04-12 13:21:28','2024-04-12 13:22:15','NGN',1.000000);
...
INSERT INTO `Users` VALUES (1,'Adeolu Adewusi','Male','Gen Z','damola.adewusi@gmail.com','(+234)8184380439','Nigeria','$2a$10$eGdk4PHNih5f9zheaf5Nl.ja0GlNgU.UpqHZM9BUwlHKwyXXVRuwq',0,'Inactive',0,'2022-08-19 19:23:25','2022-08-19 19:23:25',NULL),(3,'Damola','Male','WW II','damsy21@yahoo.com','(+234)08184380439','Nigeria','$2a$10$lqwfivk2lYwE/V2x29lEeORpaMKwDWFRm7uNzvbMldducsVnAnmZS',0,'Inactive',0,'2022-08-24 19:42:53','2022-08-24 19:42:53',NULL),(5,'Babatunde','Male','Gen X','techsupport@wofasummit.org','(+234)07019380439','Nigeria','$2a$10$fGN7uvDFUhBF4pvvRQJzp.W791a7v0rTLQ8.cbDtlPLdARBSz.INO',0,'Inactive',0,'2022-09-01 22:34:56','2022-09-01 22:34:56',NULL),(6,'Tester1','Female','Millennials','everythingbadagry@gmail.com','(+234)08068809624','Nigeria','$2a$10$n0q0YyiigNe8j5LmWKlzAe8P7Huy.XHbNgNFPUTkYSKAG6azsBXw.',0,'Inactive',0,'2022-09-01 22:44:23','2022-09-01 22:44:23',NULL),(7,'Dee','Male','Gen X','web_admin@serverpointnig.com','(+234)08344478789','Nigeria','$2a$10$14Jhgvy9I5i24sskSOfppO28LaJy/4.BPcHPVCT1.cnRiC8vCweCy',0,'Inactive',0,'2022-09-02 09:36:16','2022-09-02 09:36:16',NULL),(9,'Olayinka Adewusi','Female','Boomers I','spclouddbase@gmail.com','(+234)11223344567','Nigeria','$2a$10$iGAGt6J0lpfWZwStGKjwvO.1m/78z5MAOwMXfIkLRgVcJiXNYtype',0,'Inactive',0,'2022-09-02 09:45:53','2022-09-02 09:45:53',NULL),(10,'Oladapo Olawore','Female','Gen X','modivi8272@otodir.com','(+234)88765434345','Nigeria','$2a$10$ANKfu76GwKf3jTo86HVX0Ovr1VdW